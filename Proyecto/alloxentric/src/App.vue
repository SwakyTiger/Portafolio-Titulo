      ...
      <v-container class="d-flex align-center" style="margin-right: 0px;">
        ...
        <nav class="d-none d-md-flex align-center">
          ...
          <v-btn v-if="!isAuthenticated" text
            href="http://34.176.251.141/realms/Transcriptor/protocol/openid-connect/registrations?client_id=transcriptor_alloxentric&response_type=code&scope=openid&redirect_uri=http:/http://34.176.251.141:8080/"
    ...
    <v-navigation-drawer v-model="drawer" app temporary>
      <v-list>
        ...
        <v-list-item v-if="!isAuthenticated"
          href="http:/http://34.176.251.141/realms/Transcriptor/protocol/openid-connect/registrations?client_id=transcriptor_alloxentric&response_type=code&scope=openid&redirect_uri=http:/http://34.176.251.141:8080/">
